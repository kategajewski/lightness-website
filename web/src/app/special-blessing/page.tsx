...
export const metadata = createPageMetadata({ title: "Private Ceremonies, Blessings & Home Clearings", description: "Custom mother blessingways, baby blessings, home clearings, sacred rituals, and private ceremonies created with intention by Kate Gajewski.", path: "/special-blessing", image: "/homepage-images/private-events-ceremony.jpeg" });
