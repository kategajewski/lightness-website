...
export default function SoundTrainingPage() {
  return (
    <PageShell
      ...
      description="Led by Kate Gajewski and Raquel Vamos, this immersive in-person training takes place January 29 through 31, 2027 and explores instruments, facilitation and grounded sound practice."
    >
      ...
      <section className="rounded-[30px] border border-[rgba(76,58,48,0.08)] bg-[rgba(255,251,246,0.78)] p-8 shadow-[0_24px_80px_rgba(59,41,31,0.08)] sm:p-10">
        <div className="max-w-[46rem]">
          ...
          <h2 className="display-section-title">January 29 through 31, 2027</h2>
          <p className="mt-4 text-[var(--color-muted)]">
            Registration and payment are not open yet. Join the waitlist to be
            the first to receive the full schedule and enrollment details when
            they are ready.
          </p>
        </div>
