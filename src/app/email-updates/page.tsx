...
const updateOptions = [
  ...
  },
  {
    value: "yoga",
    label: "Yoga classes",
    description: "Weekly schedule updates, special classes, and gentle movement offerings.",
  },
  {
    value: "reiki",
    label: "Reiki trainings",
    description: "Reiki Rising cohorts, Level 1 and Level 2 education, and announcements.",
  },
  {
    value: "sound",
  ...
  },
  {
    ...
    description: "Healing sessions, group experiences, blessings, and custom ceremonies.",
  },
  {
    value: "membership",
    label: "Membership and Reiki Rising updates",
    description: "Monthly membership notes and student portal or course updates.",
  },
  {
    value: "online_programs",
    label: "Online programs",
    description: "Self-paced and online offerings for healing, learning, and practice.",
  },
] as const;
