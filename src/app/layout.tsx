...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/homepage-images/about-pinkbowlsmile.jpeg",
        width: 1200,
        height: 630,
        alt: "Kate Gajewski at The Lightness of Being",
      },
    ],
  },
  twitter: {
  ...
  "@graph": [
    {
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          ...
          "Hypnotherapy and regression sessions",
          "Private sound healing",
          "Reiki training and mentorship",
          "Sound practitioner training",
          "Yoga, meditation, and community events",
          "Corporate wellness experiences",
          "Private ceremonies and blessings",
          "Monthly healing membership",
          "Custom rose-petal rosaries, malas, and prayer strands",
          "Gift certificates",
      ...
      <body className="min-h-full flex flex-col">
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(discoveryGraph).replace(/</g, "\\u003c"),
          }}
        />
