...
export const metadata = createPageMetadata({ title: "Sound Practitioner Training on Long Island", description: "Immersive sound healing practitioner training with Kate Gajewski for facilitating private sessions, classes, ceremonies, and restorative group experiences.", path: "/sound-training", image: "/homepage-images/moodysound.jpeg" });
