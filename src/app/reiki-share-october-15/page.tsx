...
export const metadata = createPageMetadata({
  title: "Reiki Share on October 15, 2026",
  description:
    "Join a small practitioner-only Reiki Share at The Lightness of Being in Patchogue on October 15, 2026.",
  path: "/reiki-share-october-15",
  image: "/homepage-images/services-gasho.jpeg",
});
...
const eventJsonLd = {
  ...
  offers: {
    ...
    url: `${site.url}${site.links.reikiShareOctober}`,
  },
};

export default function ReikiShareOctoberPage() {
  return (
    <PageShell
      ...
      <section className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
        <div className="rounded-[34px] border border-[rgba(76,58,48,0.08)] bg-[linear-gradient(135deg,rgba(255,250,244,0.95),rgba(241,231,220,0.92))] p-8 shadow-[0_24px_80px_rgba(59,41,31,0.08)] sm:p-10">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <EventCheckoutForm
              eventSlug="reiki-share-october-15-2026"
