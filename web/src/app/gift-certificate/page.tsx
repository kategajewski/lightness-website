...
export const metadata = createPageMetadata({ title: "Healing & Wellness Gift Certificates", description: "Give a flexible gift certificate for Reiki, energy healing, sound healing, guidance, events, training, and other offerings from The Lightness of Being.", path: "/gift-certificate", image: "/homepage-images/gift-certificate-lantern.jpeg" });
