...
export const metadata = createPageMetadata({
  title: "Corporate Wellness, Sound Baths & Yoga on Long Island",
  description: "Customized workplace sound baths, guided meditation, yoga, and restorative wellness experiences for teams, retreats, and organizations on Long Island.",
