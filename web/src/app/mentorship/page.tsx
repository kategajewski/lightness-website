...
export const metadata = createPageMetadata({ title: "Private Reiki Mentorship & Practitioner Development", description: "Personalized one-to-one Reiki mentorship with Kate Gajewski, from foundational training through mastery, teaching, and embodied practitioner development.", path: "/mentorship", image: "/homepage-images/embodied-healer-mentorship.jpeg" });
